...
public class MAR00002Analyzer : DiagnosticAnalyzer
{
	public const string DiagnosticId = "MAR00002";
	...
	private bool IsPublicMethod( MethodDeclarationSyntax methodDeclarationNode)
	{
	...
	private void AnalyzeSyntax(SyntaxNodeAnalysisContext context)
	{
		...
		if (!IsPublicMethod(methodDeclarationNode))
		{
			return;
		}

		var methodName = methodDeclarationNode.Identifier.ToString();
